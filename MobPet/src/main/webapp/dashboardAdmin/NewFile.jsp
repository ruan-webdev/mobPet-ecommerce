...
<body class="animsition">
            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="chart.jsp">
                                <i class="fas fa-chart-bar"></i>+ GrÃ¡ficos</a>
                        </li>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <form>
                                            ...
                                            <button class="btn btn-primary"><a href="pedidos.jsp">Voltar</a></button>

                                            <input type="submit"><button class="btn btn-primary"><a href="pedidos.jsp">Salvar</a></button>
                                          </form>
                                    </div>
                                </div>
                            </div>
    ...
    <!-- Jquery JS-->
    <script src="vor/jquery-3.2.1.min.js"></script>
