                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Cadastro</strong> Produto
                                    </div>
                                        ...
                                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="text-input" name="text-input" placeholder="Nome do produto" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="text-input" name="text-input" placeholder="Marca do produto" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-6 col-md-4">
                                                    <select name="select" id="select" class="form-control">
                                                        ...
                                                        <option value="2">Medicação</option>
                                                        <option value="3">Roupa</option>
                                                        <option value="4">Acessórios</option>
                                                        <option value="5">Higiêne</option>
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input" class=" form-control-label">Preço unitário</label>
                                                </div>
                                                <div class="col-6 col-md-3">
                                                    <input maxlength="10" type="text" id="dinheiro" name="dinheiro" class="dinheiro form-control" style="display:inline-block" />
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <textarea name="textarea-input" id="textarea-input" rows="9" placeholder="Conteúdo..." class="form-control"></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="file-input" class=" form-control-label">Imagem promocional</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="file-multiple-input" class=" form-control-label">Outras imagens</label>
                                                </div>
                                                <div class="col-12 col-md-9">
