            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <h2 class="title-1 m-b-25">Produtos disponíveis</h2>
                                <div class="table-responsive table--no-card m-b-30">
                                    ...
                                    <div class="table-data__tool">
                                        ...
                                        <div class="table-data__tool-right">
                                            <a href="form.jsp"><button class="au-btn au-btn-icon au-btn--green au-btn--small">
                                    ...
                                    <table class="table table-borderless table-striped table-earning">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>100397</td>
                                                <td>Petiscos Pedigree</td>
                                                <td class="text-right">R$16.00</td>
                                                <td class="text-left">1450</td>
                                                <td>
                                                    <div class="table-data-feature">
                                                        <button class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                                            <i class="zmdi zmdi-edit"></i>
                                            ...
                                            <tr>
                                                ...
                                                <td>100396</td>
                                                <td>Shampoo dona Cat</td>
                                                <td class="text-right">R$22.00</td>
                                                <td class="text-left">870</td>
                                                <td>
                                                    <div class="table-data-feature">
                                                        <button class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                                            <i class="zmdi zmdi-edit"></i>
                                            ...
                                            <tr>
                                                ...
                                                <td>100392</td>
                                                <td>Brinquedinhos</td>
                                                <td class="text-right">R$59.00</td>
