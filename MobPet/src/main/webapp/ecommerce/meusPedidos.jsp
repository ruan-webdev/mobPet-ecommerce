...
<body class="js">
	...
	<div class="sidebar">
		...
		<a href="perfilCliente.jsp"> <i class="fas fa-user"></i> <span>Alterar
				...
				Senha</span>
		</a> <a href="adicionarEndereco.jsp"> <i class="fas fa-map-marker-alt"></i>
			<span>Endereços</span>
		...
		<a href="meusPedidos.jsp" class="active"> <i
			class="fas fa-box-open"></i> <span>Status</span>
	...
	<form id="dadosCliente" action="#" method="POST">
		...
		<table class="table table-bordered" style="width: 800px">
			...
			<tbody>
				<tr class='clickable-row' 
					data-href='sales.html'>
					<td>2018-09-29 05:57</td>
					<td>Ração</td>
					<td>....</td>
					<td class="denied">Aguardando Pagamento</td>
					<td>R$99.00</td>
					<td><button onclick="solicitarTrocar()" style="color:white; background-color:green; height: 50px;" >Solicitar Troca</button></td>
					<td><button onclick="cancelarCompra()" style="color:white; background-color:red; height: 50px;">Cancelar Pedido</button></td>
				</tr>
				...
				<tr class='clickable-row' 
					...
					<td>Brinquedo</td>
					<td>...</td>
					<td class="process">Pedido Enviado</td>
					<td>R$56.00</td>
					<td><button onclick="solicitarTrocar()" style="color:white; background-color:green; height: 50px;">Solicitar Troca</button></td>
					<td><button onclick="cancelarCompra()" style="color:white; background-color:red; height: 50px;">Cancelar Pedido</button></td>
				</tr>
		...
		<div>
		<button onclick="meusCupons()" style="color:white;background-color: #424277;float: right;width: 150px;height: 50px;">Meus Cupons</button>
	</div>
				...
				<div class="inner">
					<div class="row">
						<div class="col-lg-6 col-12">
							<div class="left">
								<p>Copyright © 2020 MobPet - Todos os direitos reservados.</p>
							</div>
						</div>
						<div class="col-lg-6 col-12">
							<div class="right">
	...
	function cancelarCompra() {
		...
		var x;
		var r = confirm("Deseja cancelar esse pedido?");
		if (r == true) {
			x = alert("Compra cancelada com sucesso!")
			 return true;
		}
		else {
			return false; 
	...
	<script>
	function solicitarTrocar() {

		var x;
		var r = confirm("Deseja Solicitar a troca desse produto?");
		if (r == true) {
			x = prompt("Digite o codigo de troca");		
			x = alert("Troca solicitada com sucesso")
			 return true;
