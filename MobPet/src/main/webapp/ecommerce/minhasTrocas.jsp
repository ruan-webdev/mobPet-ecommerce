...
<body class="js">
	...
	<div class="sidebar">
		...
		<a href="meusPedidos.jsp"> <i
			class="fas fa-box-open"></i> <span>Status</span>
		</a> <a href="minhasTrocas.jsp" class="active"> <i class="fas fa-people-carry"></i> <span>Trocas</span>
		</a>
	</div>
	...
	<form id="dadosCliente" action="alterarPedido" method="POST">
