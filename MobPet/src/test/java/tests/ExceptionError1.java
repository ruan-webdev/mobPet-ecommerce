...
public class ExceptionError1 {
	...
	private void clicarCadastro() throws InterruptedException {
		...
		// senhas vão ser colocadas erradas propositalmente;
		...
		campoRepetirSenha.sendKeys("123466");
		Thread.sleep(1000);
	...
	@Test
	public void passswordTest()throws InterruptedException {
		clicarCadastro();
		fail("erro no cadastro de senhas");
	}
}